...
open_router_model_client = OpenAIChatCompletionClient(
    ...
    model_info = {
    "type": "chat_completion",     # REQUIRED: model type (chat, completion, embedding)
    "vision": False,               # REQUIRED: does model support vision input?
    "audio": False,                # REQUIRED: does model support audio input/output?
    "function_calling": False,
    "json_output": True,      # REQUIRED: does the model support tool calling?
    "input_format": "text",        # REQUIRED: text / vision / audio
    "output_format": "text",       # REQUIRED: text / vision / audio
    "context_window": 8192,        # REQUIRED: maximum tokens supported
    "provider": "openrouter",      # REQUIRED: who hosts the model?
    "description": "Open-source 20B chat model via OpenRouter",  # OPTIONAL
    "family": "gpt-oss",           # OPTIONAL: internal grouping tag
    "temperature": 1.0,            # OPTIONAL: default value
    "top_p": 1.0,                  # OPTIONAL
}
)
